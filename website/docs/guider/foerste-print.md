...
Når printen er ferdig, viser dashboardet en fullført-melding (og sender varsel hvis du har satt opp [varsler](./varsler-oppsett)).
...
- **Vei tomme spoler** — legg inn startvekt på spoler for nøyaktig restberegning (se [Filamentlager](./filament-oppsett))
- **Sett opp Telegram-varsel** — få beskjed når printen er ferdig uten å sitte og vente (se [Varsler](./varsler-oppsett))
- **Sjekk byggplaten** — ren plate = bedre heft. Tørk av med IPA (isopropanol) mellom prints
- **Bruk riktig plate** — se [Velge rett byggplate](./velge-rett-plate) for hva som passer ditt filament
