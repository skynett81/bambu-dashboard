...
2. Fill in:
   ...
   - **Customer** — optional customer account (see [E-commerce](../integrasjoner/ecommerce))
...
| Machine wear | Calculated from [Wear Prediction](../overvaaking/wearprediction) |
...
Enable the Tibber or Nordpool integration for accurate electricity costs per print. See [Energy](../integrasjoner/energy).
:::
...
:::info Customer data
Customer data (name, address, org. number) is pulled from the customer account linked to the project. See [E-commerce](../integrasjoner/ecommerce) to manage customers.
:::
